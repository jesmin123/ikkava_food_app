                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Divider(thickness: 2,indent: 8,endIndent: 8,),
                        FlatButton(onPressed: (){Navigator.push(context, PageTransition(child: Order3(), type: PageTransitionType.leftToRightWithFade));},shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15),),
                            minWidth: MediaQuery.of(context).size.width*0.35,
                            color: APP_GREEN_COLOR,
                            child: Text("Arrived Location",style: AppFontStyle.titleAppBarStyle(APP_WHITE_COLOR),))
                      ],
                    ),
                  ),
                ),
